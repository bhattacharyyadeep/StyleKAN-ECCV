...
def main():
    ...
    parser.add_argument("--dino_ckpt", type=str, default="./dinov3_vitb16_pretrain.pth",help="Path to the pretrained DINO checkpoint (.pth). "
    ...
    save_root = f"./runs/segdino_batch16_{args.dino_size}_{args.input_h}_{args.dataset}"
